	...
	<view :style='{"width":"100%","flexWrap":"wrap","background":"#ffffff","display":"flex","height":"100%"}'>
		...
		<view class="listBox recommend" :style='{"width":"100%","margin":"40rpx 0 40rpx 0","background":"#ffffff","order":"10"}'>
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"20rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231130/99a276c461c94b9a9ab19652b1976f71.png) no-repeat center top / 100% 100%","height":"auto"}'>
				<view :style='{"padding":"8rpx 60rpx 8rpx 60rpx","color":"#333","borderRadius":"8rpx","textAlign":"center","background":"none","display":"inline-block","width":"auto","fontSize":"32rpx","lineHeight":"48rpx","minWidth":"300rpx","fontWeight":"500"}'>流浪动物推荐</view>
			</view>
			...
			<view class="list-box style3" :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","margin":"40rpx 0 0 0","height":"auto"}'>
				<view @tap="onDetailTap('liulangdongwu',product.id)" v-for="(product,index) in liulangdongwulist" :key="index" class="list-item" :style='{"boxShadow":"0 0px 0px #00000030","margin":"0 0 40rpx 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
					<image :style='{"width":"200rpx","margin":"0 20rpx 0 0","objectFit":"cover","borderRadius":"0px","display":"block","height":"200rpx"}' class="list-item-image" mode="aspectFill" v-if="product.zhaopian.substring(0,4)=='http'" :src="product.zhaopian"></image>
					<image :style='{"width":"200rpx","margin":"0 20rpx 0 0","objectFit":"cover","borderRadius":"0px","display":"block","height":"200rpx"}' class="list-item-image" mode="aspectFill" v-else :src="product.zhaopian?baseUrl+product.zhaopian.split(',')[0]:''"></image>
					<view class="list-item-body" :style='{"width":"calc(100% - 240rpx)","padding":"0 0 0 0","margin":"0 0 0 0","height":"auto"}'>
						<view :style='{"border":"2rpx solid #eeeeee","padding":"0 20rpx 0 20rpx","margin":"0 0 12rpx","whiteSpace":"nowrap","color":"#333","textAlign":"center","overflow":"hidden","borderRadius":"0px","background":"#fff00010","width":"100%","lineHeight":"52rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"52rpx"}' class="list-item-title">{{product.dongwumingcheng}}</view>
						<view :style='{"border":"2rpx solid #eeeeee","padding":"0 20rpx 0 20rpx","margin":"0 0 12rpx","whiteSpace":"nowrap","color":"#333","textAlign":"center","overflow":"hidden","borderRadius":"0px","background":"#fff00010","width":"100%","lineHeight":"52rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"52rpx"}' class="list-item-title">{{product.lingyangzhuangtai}}</view>
					</view>
				</view>
			</view>
		...
		<!-- 商品列表 -->
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"20rpx 80rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231130/99a276c461c94b9a9ab19652b1976f71.png) no-repeat center top / 100% 100%","height":"auto"}'>
				<view :style='{"padding":"12rpx 60rpx 8rpx 120rpx","color":"#333","borderRadius":"8rpx","background":"none","display":"inline-block","fontSize":"32rpx","lineHeight":"48rpx","minWidth":"300rpx","fontWeight":"500"}'>公告资讯</view>
				<text :style='{"margin":"10rpx 0 0 0","color":"#666","display":"inline-block","width":"auto","fontSize":"28rpx","lineHeight":"48rpx","float":"right"}' @tap="onPageTap('gonggaozixun')">查看更多</text>
			</view>
		  ...
		  <view class="list-box style1" :style='{"padding":"24rpx 24rpx 24rpx 24rpx","margin":"0 0 0 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<view @tap="onDetailTap('gonggaozixun',product.id)" v-for="(product,index) in homegonggaozixunlist" :key="index" class="list-item" :style='{"border":"0px solid #3da74250","boxShadow":"0 0px 0px #cccccc","padding":"20rpx","margin":"0 0 40rpx 0","backgroundColor":"#ffffff","borderRadius":"8rpx","textAlign":"center","flexWrap":"wrap","display":"flex","width":"48%","justifyContent":"center","height":"auto"}'>
			                			  <view :style='{"border":"2rpx solid #eeeeee","padding":"0px 20rpx 0px 20rpx","margin":"0 0 12rpx 0","whiteSpace":"nowrap","color":"#333333","overflow":"hidden","borderRadius":"0px","background":"#fff00010","width":"100%","fontSize":"28rpx","lineHeight":"48rpx","textOverflow":"ellipsis","height":"48rpx","order":"2"}' class="list-item-title ">{{product.biaoti}}</view>
	...
	export default {
		...
		async onShow() {
			...
			if(uni.getStorageSync("userid")) {
				res = await this.$api.recommend2('liulangdongwu', {                                              
                    page: 1,
                    limit: 4
                });
			} else {
				res = await this.$api.recommend('liulangdongwu', {                                              
                    page: 1,
                    limit: 4
                });
			}
			this.liulangdongwulist = res.data.list

			res = await this.$api.list('gonggaozixun', {
				page: 1,

				limit: 4
			});
			this.homegonggaozixunlist = res.data.list
		},
